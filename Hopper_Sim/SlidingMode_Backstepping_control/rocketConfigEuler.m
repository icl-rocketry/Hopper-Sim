...
P.alpha1 = 0.009;     % mdot coeff.
P.alpha2 = 0.005;     % Jdot coeff.
P.beta   = 0.03;      % throttle → flow-rate

%% ========== DISTURBANCE MODEL ===========================================
P.useDist          = true;                 % <-- set TRUE so the lines below take effect
% --- Force disturbance ---------------------------------------------------
...
P.traj.stepTarget = [0.1; 0.1; 0];  % [x; y; z] you want after the step
% ----------------------------------------------------------

%% ========== OUTER-LOOP TRANSLATION GAINS ================================
P.kPos1          = [5  5  4];     % k₁ for x, y, z
P.kPos2          = [2 2 5];     % k₂ for x, y, z
P.lambdaPosOuter = [8  8  8];     % λ  for x, y, z
P.etaPosOuter    = 0.5;         % same η for all axes
P.psiPosOuter    = [0.1 0.1 0.1]; % ψ  per axis

%% ========== INNER-LOOP (Fz) GAINS =======================================
P.kPos3 = 10;   P.kPos4 = 10;
P.lambdaPosInner = 8;
P.etaPosInner    = 0.5;
P.psiPosInner    = 0.1;%dont set to 0, 

%% ========== ATTITUDE GAINS ==============================================
P.kAtt1 = 20;  P.kAtt2 = 20;
P.lambdaAtt = 8;
P.etaAtt    = 2;
P.psiAtt    = 0.2;%Dont set to 0
